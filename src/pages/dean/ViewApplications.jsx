...
function ViewApplications() {
  ...
  const acceptApplication = async (id) => {
    try {
          axios.post(`http://localhost:5000/create/review/application`,{
  ...
  const rejectApplication = async (id) => {
    try {
        axios.post(`http://localhost:5000/create/rejected/application`,{
          student_id: applicantData.student_id,
      ...
      <div className="dean-view-applications">
        <div className="dean-view-header">
          ...
          <div>
            ...
            <select name="applications-course" id='dean-select-course' onChange={(e)=>setSelectChange(e.target.value)} value={selectChange}>
              {course_options} 
            </select>
          </div>
        </div>
